...
enum display_pos_e { DISPLAY_LEFT, DISPLAY_RIGHT, DISPLAY_TOP_LEFT, DISPLAY_MIDDLE_LEFT, DISPLAY_BOTTOM_LEFT, DISPLAY_CENTER };
enum display_font_e { DISPLAY_FONT_DEFAULT, DISPLAY_FONT_SEGMENT, DISPLAY_FONT_TINY, 
					  DISPLAY_FONT_SMALL,  DISPLAY_FONT_MEDIUM, DISPLAY_FONT_LARGE, DISPLAY_FONT_HUGE };
enum displayer_cmd_e { DISPLAYER_SHUTDOWN, DISPLAYER_ACTIVATE, DISPLAYER_SUSPEND }					  ;
...
extern struct display_s {
	...
	bool (*line)(int num, enum display_pos_e pos, int offset, int attribute, char *text);
